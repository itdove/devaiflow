...
def mock_github_client():
    ...
    with patch('devflow.cli.commands.git_add_comment_command.GitRemoteDetector') as mock_detector_class:
        mock_detector = Mock()
        mock_detector.parse_repository_info.return_value = ('github', 'owner', 'repo')
        mock_detector_class.return_value = mock_detector

        # Patch the factory to return a mock client
        with patch('devflow.cli.commands.git_add_comment_command.create_issue_tracker_client') as mock_factory:
            mock_client = Mock()
